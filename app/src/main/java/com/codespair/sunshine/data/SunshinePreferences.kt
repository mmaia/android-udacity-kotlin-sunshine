 ...
 */
package com.codespair.sunshine.data
...
class SunshinePreferences {
  ...
  companion object {
     ...
     */
    @JvmStatic val PREF_CITY_NAME = "city_name"

    /*
     * In order to uniquely pinpoint the location on the map when we launch the
     * map intent, we store the latitude and longitude.
     */
    @JvmStatic val PREF_COORD_LAT = "coord_lat"
    @JvmStatic val PREF_COORD_LONG = "coord_long"

    /*
     * Before you implement methods to return your REAL preference for location,
     * we provide some default values to work with.
     */
    @JvmStatic val DEFAULT_WEATHER_LOCATION = "94043,USA"
    @JvmStatic val DEFAULT_WEATHER_COORDINATES: DoubleArray = doubleArrayOf(37.4284, 122.0724)

    @JvmStatic val DEFAULT_MAP_LOCATION =
